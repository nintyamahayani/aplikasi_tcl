...
<head>
    <link href="{{asset('template')}}/assets/img/cs.png" rel="icon">
...
<body class="light-edition">
    <div class="wrapper ">
        <div class="sidebar" data-color="purple" data-background-color="black" data-image="{{asset('template')}}/assets/img/gege.jpg">
            <!-- <div class="logo">
                <a class="simple-text logo-normal">
                    <img src="{{asset('template')}}/assets/img/cs.png" class="brand-image img-circle elevation-3"
                        style="opacity: .8" width="50px">
                    <span class="simple-text logo-normal">ILMU KOMPUTER</span>
                </a>
            </div> -->
